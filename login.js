(function () {
  ...
  if (!scriptSeleccionado) {
    ...
    bg.style.backgroundImage = "url('https://wormx.store/images/arkaplan/bg1.jpg')"; // Ä°stediÄŸin gÃ¶rsel buraya
    ...
    function crearMenu() {
      ...
      container.innerHTML = `
        ...
        <div id="announcement" aria-live="polite" aria-atomic="true">
          ...
          <div id="news-ticker">
            ...
            <p>ðŸ”¥ Worm âŒ Ã§ok yakÄ±nda geliyor!</p>
      ...
      estilos.innerHTML = `
        body, html {
          ...
          color: white;
          user-select: none;
          background: transparent !important; /* transparent ki arka plan gÃ¶rÃ¼nsÃ¼n */
        }
    ...
    document.getElementById('opcion2').addEventListener('click', function () {
      cargarScript('https://25yt551.github.io/wormt-r/new/game.php');
    });
